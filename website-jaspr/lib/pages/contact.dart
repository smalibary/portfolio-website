      ...
      main_(classes: 'contact-page', [
        ...
        section(classes: 'contact-alt', [
          ...
          div(classes: 'contact-alt__grid', [
            a(href: email.isNotEmpty ? email : '#', classes: 'contact-alt__card', [
              raw('<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M0 4v16h24V4H0zm21.518 2L12 12.713 2.482 6h19.036zM2 18V7.51l9.428 6.628a1 1 0 0 0 1.144 0L22 7.51V18H2z"/></svg>'),
              span(classes: 'contact-alt__label', [text('EMAIL')]),
              span(classes: 'contact-alt__value', [text(emailAddr)]),
            ]),
